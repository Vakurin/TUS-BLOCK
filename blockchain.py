...
class Blockchain:
    ...
    # Сеттер для свойства цепи
    @chain.setter
    def chain(self, val):
        self.__chain = val

    def get_open_transactions(self):
        """Возращает копию листа открытых транзакций."""
        return self.__open_transactions[:]

    def load_data(self):
        """Инициализация blockchain + открытые транзакции данный из файла."""
        try:
            with open('blockchain-{}.txt'.format(self.node_id), mode='r') as f:
                ...
                # Нужно конвертировать загруженные данные, потому что Транзакции используют OrderedDict
                updated_blockchain = []
                ...
                # Нужно конвертировать загруз дату, потому что Транзакции используют OrderedDict
    ...
    def save_data(self):
        """Сохранение blockchain + открывает снимок транзакции в файл."""
        try:
    ...
    def get_balance(self, sender=None):
        """Рассчитайте и верните баланс участника.
        """
        if sender == None:
    ...
    def get_last_blockchain_value(self):
        """ Возвращает последнее значение текущего блокчейна. """
    ...
    def mine_block(self):
        """Создает новый блок и добавляет открытую транзакцию для него"""
